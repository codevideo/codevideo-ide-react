    ...
    if (currentActionIndex < actions.length - 1) {
      ...
      if (typeof (window as any).__onActionProgress === 'function') {
        (window as any).__onActionProgress({
          ...
          progress: (nextIndex / (actions.length - 1) * 100).toFixed(1),
      ...
      // Send final progress update before signaling completion
      if (typeof (window as any).__onActionProgress === 'function') {
        (window as any).__onActionProgress({
      ...
      // Signal completion to puppeteer when we've reached the end of actions
      (window as any).__replayCompleted = true;
    }
  }
